 ...
 */
import { ApiErrorResponseV2ErrorIssuesInner } from './apiErrorResponseV2ErrorIssuesInner';


export interface ApiErrorResponseV2Error { 
    /**
     ...
     */
    issues: Array<ApiErrorResponseV2ErrorIssuesInner>;
}

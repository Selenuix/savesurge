 ...
 */
export type ChargeBearerType = 'DEBT' | 'CRED' | 'SHAR' | 'SLEV';

export const ChargeBearerType = {
    Debt: 'DEBT' as ChargeBearerType,
    Cred: 'CRED' as ChargeBearerType,
    Shar: 'SHAR' as ChargeBearerType,
    Slev: 'SLEV' as ChargeBearerType
};

...
export interface NonSweepingPeriodicLimits { 
    ...
    /**
     * __Mandatory__. Frequency for which the payment limits are enforced. Allowed values are [DAILY, WEEKLY, EVERY_TWO_WEEKS, MONTHLY, YEARLY]. This field cannot be enforced when `recurringPaymentCategory=ONGOING`.
     */
    frequency?: string;
    /**
